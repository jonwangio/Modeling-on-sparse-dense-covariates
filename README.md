...
1 Background
-------------------
In geoscience, the history of continuous field inference through point observations came along with decades of discussion and exploration of uncertainty. The discussion of the uncertainty in terms of accuracy or error is still active till recent years despite interpolation has been treated and applied as a sophisticated technique. Some of the discussion remains around basic issues such as characterizing the inference accuracy such as shown in the paper [_IS THE ORDINARY KRIGING VARIANCE A PROPER MEASURE OF INTERPOLATION ERROR?_](https://www.researchgate.net/profile/Gerard_Heuvelink/publication/46629588_Is_the_ordinary_kriging_variance_a_proper_measure_of_interpolation_error/links/55891d9108ae5b21e3f31d8b.pdf) by Heuvelink & Pebesma, 2002.

Stay within the domain of geoscience, this snippet of scientific experiment is fully devoted to examine the accuracy in the problem of using point observations to recunstruct continuous field. You can imagine accuracy as a function of several properties of observation at hand: quality, density, distribution, variation, etc. Then there are several scenarios of field reconstruction accuracy depending on the combination of observation properties, which are well worth understanding. Exhaustively exploration of the scenarios is fundamental to understand the potentials and limitations of observations in reconstructing the underlying continuous field(s), or at least have an impression of reliability of using limited observations at hand, in real life cases. However, enumerate every scenario can be tedious. 
